class FromStrings {
  ...
  static String hotPod = "داغترین پادکست ها";
  static String techBlogGitHub = "https://github.com/sasansafari/techblog";
  static String editProfileName = "ویرایش عکس پروفایل";
  static String real = "نوشته های مرتبط";
  static String sendArt = "ارسال مقاله";
  static String sendPod = "ارسال پادکست";
  ...
  static String insertActivateCode = "کد فعال سازی رو وارد کن";
